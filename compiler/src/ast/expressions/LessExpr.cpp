...
LessExpr::LessExpr(ExprNode *operand1, ExprNode *operand2)
    : BinaryExpr(operand1, operand2) {}

std::string LessExpr::generateAsm(std::ostream &out) {
...
intmax_t LessExpr::operation(intmax_t operand1, intmax_t operand2) {
