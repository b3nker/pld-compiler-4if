...
LessOrEqualExpr::LessOrEqualExpr(ExprNode *operand1, ExprNode *operand2)
    : BinaryExpr(operand1, operand2) {}

std::string LessOrEqualExpr::generateAsm(std::ostream &out) {
...
intmax_t LessOrEqualExpr::operation(intmax_t operand1, intmax_t operand2) {
