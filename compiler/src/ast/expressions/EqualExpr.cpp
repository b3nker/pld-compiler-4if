...
EqualExpr::EqualExpr(ExprNode *operand1, ExprNode *operand2)
    : BinaryExpr(operand1, operand2) {}

std::string EqualExpr::generateAsm(std::ostream &out) {
...
intmax_t EqualExpr::operation(intmax_t operand1, intmax_t operand2) {
