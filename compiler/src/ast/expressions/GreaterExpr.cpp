...
GreaterExpr::GreaterExpr(ExprNode *operand1, ExprNode *operand2)
    : BinaryExpr(operand1, operand2) {}

std::string GreaterExpr::generateAsm(std::ostream &out) {
...
intmax_t GreaterExpr::operation(intmax_t operand1, intmax_t operand2) {
